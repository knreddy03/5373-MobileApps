...
def delete_image(image_id: str):
    """
    Remove an image from the collection by its ID.
    """
    mm.setCollection("images")
    result = mm.delete(query={"_id": image_id})
...
def delete_location(location_id: str):
    """
    Remove a location from the collection by its ID.
    """
    mm.setCollection("locations")
    result = mm.delete(query={"_id": location_id})
...
def delete_user(user_id: str):
    mm.setCollection("users")  # Ensure collection is set
    result = mm.delete(query={"_id": user_id})
